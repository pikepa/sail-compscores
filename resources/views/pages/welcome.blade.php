<x-guest-layout>
    <div class="  relative flex items-top justify-center min-h-screen dark:bg-gray-900 sm:items-center py-4 sm:pt-0">
        ...
        <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
            @auth
            <a href="{{ route('clients') }}" class="text-sm text-gray-700 dark:text-gray-500 underline">Client Dashboard</a>
            @else
        ...
        <div class="max-w-6xl mx-auto flex-col sm:px-6 lg:px-8 text-blue-800">
